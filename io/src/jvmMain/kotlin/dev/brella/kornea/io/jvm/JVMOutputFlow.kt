...
public open class JVMOutputFlow(protected val stream: OutputStream): BaseDataCloseable(), OutputFlow, PrintOutputFlow, OutputFlowState, IntFlowState by IntFlowState.base() {
