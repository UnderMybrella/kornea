...
@ExperimentalUnsignedTypes
public suspend fun <T> T.peekFloatBE(): Float? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt32BE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekFloatLE(): Float? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt32LE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekFloat32BE(): Float? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt32BE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekFloat32LE(): Float? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt32LE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekDoubleBE(): Double? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt64BE()?.let { Double.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekDoubleLE(): Double? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt64LE()?.let { Double.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekFloat64BE(): Double? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt64BE()?.let { Double.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.peekFloat64LE(): Double? where T: Int16FlowState, T: PeekableInputFlow = this.peekInt64LE()?.let { Double.fromBits(it) }
...
@ExperimentalUnsignedTypes
public suspend fun <T> T.readFloatBE(): Float? where T: Int16FlowState, T: InputFlow = this.readInt32BE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readFloatLE(): Float? where T: Int16FlowState, T: InputFlow = this.readInt32LE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readFloat32BE(): Float? where T: Int16FlowState, T: InputFlow = this.readInt32BE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readFloat32LE(): Float? where T: Int16FlowState, T: InputFlow = this.readInt32LE()?.let { Float.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readDoubleBE(): Double? where T: Int16FlowState, T: InputFlow = this.readInt64BE()?.let { Double.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readDoubleLE(): Double? where T: Int16FlowState, T: InputFlow = this.readInt64LE()?.let { Double.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readFloat64BE(): Double? where T: Int16FlowState, T: InputFlow = this.readInt64BE()?.let { Double.fromBits(it) }

@ExperimentalUnsignedTypes
public suspend fun <T> T.readFloat64LE(): Double? where T: Int16FlowState, T: InputFlow = this.readInt64LE()?.let { Double.fromBits(it) }
